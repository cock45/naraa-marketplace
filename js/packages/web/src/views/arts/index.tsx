      ...
      <div className="rectangle2 space_entire">
        <Row gutter={16} style={{padding: '100px 0'}}>
          ...
          <Col span={8} className="gutter-row">
            ...
            <Button type="primary" className="collections" size="large" style={{borderRadius:"5px", backgroundColor:"#0057FF", color:"white"}}>BUY NOW</Button>
            <h4 style={{marginTop: '50px'}}>Add to Group
              <span style={{marginLeft: '20px'}}>
                <Tooltip title={title} placement="bottomLeft">
                  <TagsTwoTone twoToneColor="#000" style={{paddingTop: '5px', color:"black", backgroundColor:"white"}} />
                </Tooltip>
              </span>
            </h4>
          </Col>
