          ...
          <div className="space-align-block" style={{backgroundColor: "#F3F3F3", padding: '15px 10px'}}>
            ...
            <div style={{justifyContent: 'space-between', display: 'flex', padding: "0 20px", marginTop: '20px'}}>
              <div style={{marginTop: '5px'}}>
                <Image src="./img/bi_image-fill.svg" preview={false} style={{paddingRight: '10px' }}  width="30px" height="30px" />
                <Image src="./img/Vector.svg" preview={false} style={{paddingRight: '10px'}}  width="30px" height="30px" />
                <Image src="./img/Vector (1).svg" preview={false} style={{}} width="30px" height="30px" />
              </div>
